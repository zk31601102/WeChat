...
//        }
        ...
        ///转为字符串
        NSString *contactName = ((NSDictionary *)obj)[@"name"];
...
//        [array addObject:contactName];
        [array addObject:obj]; // rectify 5-18 save Dictionary
...
//        NSArray *array = [[sortedArray objectAtIndex:i] sortedArrayUsingComparator:^NSComparisonResult(NSString *obj1, NSString *obj2) {
        NSArray *array = [[sortedArray objectAtIndex:i] sortedArrayUsingComparator:^NSComparisonResult(NSDictionary *dict1, NSDictionary *dict2) {  // rectify in 5-18
            NSString *obj1 = dict1[@"name"];
            NSString *obj2 = dict2[@"name"];
            ///第一个元素纯英文
...
- (void)sortContactTOTitleAndSectionRow_A_EC:(void(^)(BOOL isSuccess,NSArray *titleArray,NSArray *rowArray))callBack
{
    ...
    for (int i = 0; i < [sortedArray count]; i++) {
        ...
        NSArray *array = [[sortedArray objectAtIndex:i] sortedArrayUsingComparator:^NSComparisonResult(NSDictionary *dict1, NSDictionary *dict2) {
            NSString *obj1 = dict1[@"name"];
            NSString *obj2 = dict2[@"name"];
